...
class ContactFormManagement
{
    ...
    public function build ()
    {
        ...
        $dataGrid
            ...
            ->setAddBtnUri($this->router->generate('neutron_contact.backend.contact_form.update', array(), true))
            ->enableEditButton(true)
            ->setEditBtnUri($this->router->generate('neutron_contact.backend.contact_form.update', array('id' => '{id}'), true))
            ->enableDeleteButton(true)
            ->setDeleteBtnUri($this->router->generate('neutron_contact.backend.contact_form.delete', array('id' => '{id}'), true))
        ;
