...
class Configuration implements ConfigurationInterface
{
    ...
    private function addContactInfoConfigurations(ArrayNodeDefinition $node)
    {
        $node
            ->children()
                    ...
                    ->addDefaultsIfNotSet()
                        ->children()
                            ...
                            ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('type')->defaultValue('neutron_contact_form')->end()
                                    ->scalarNode('handler')->defaultValue('neutron_contact.form.handler.contact_info.default')->end()
                                    ->scalarNode('name')->defaultValue('neutron_contact_info')->end()
                                ->end()
                            ->end()
                            ->arrayNode('templates')
                                ->useAttributeAsKey('name')
